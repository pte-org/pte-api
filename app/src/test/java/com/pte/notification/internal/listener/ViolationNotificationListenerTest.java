...
class ViolationNotificationListenerTest {
    ...
    void onViolationDetected_noHostAdmins_noDispatch() {
        ...
        ViolationDetectedEvent event = new ViolationDetectedEvent(
                attemptPublicId, sessionPublicId, ViolationType.TAB_SWITCH, "detail", Instant.now(), tenantId);

        when(identityService.findByTenantIdAndRole(tenantId, Role.valueOf(NotificationConstants.ROLE_HOST_ADMIN)))
                .thenReturn(List.of());
    ...
    void onViolationDetected_oneHostAdmin_dispatchesOnce() {
        ...
        ViolationDetectedEvent event = new ViolationDetectedEvent(
                attemptPublicId, sessionPublicId, ViolationType.TAB_SWITCH, violationDetail, Instant.now(), tenantId);
    ...
    void onViolationDetected_threeHostAdmins_dispatchesToEach() {
        ...
        ViolationDetectedEvent event = new ViolationDetectedEvent(
                attemptPublicId, sessionPublicId, ViolationType.SUSPICIOUS_AUDIO, violationDetail, Instant.now(), tenantId);
    ...
    void onViolationDetected_noDetail_bodyDoesNotIncludeDetail() {
        ...
        ViolationDetectedEvent event = new ViolationDetectedEvent(
                attemptPublicId, sessionPublicId, ViolationType.TECHNICAL_ISSUE, null, Instant.now(), tenantId);
