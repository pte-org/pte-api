package com.pte.tenancy.domain;
...
/**
 * An immutable ledger row for a Tenant's package/quota allocation â€” never
 ...
 * on {@link Tenant} on purpose â€” nothing needs to navigate tenantâ†’
 * transactions in memory, only tenantâ†’[persisted rows via repository], so
