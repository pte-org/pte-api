package com.pte.reporting.internal.config;
...
/** Loads the versioned task-type to skill contribution map from {@code config/task-skill-mapping.json} (already vendored in this app by itembank, Phase A). */
@Component
