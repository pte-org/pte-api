 ...
 * violationType | detail | detectedAt | prevHash)} — see {@code
 * HashChainService}. Rows are never updated or deleted; integrity is verified
 * by replaying the chain in {@code sequenceNo} order.
 */
@Entity
