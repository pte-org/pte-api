 ...
 * com.pte.proctoring.domain.ViolationEvent}. Deterministic given its inputs —
 * a chain is verified by recomputing every link from the stored rows and
...
public class HashChainService {
    ...
    private String sha256Hex(String input) {
        try {
            ...
            throw new IllegalStateException(ProctorConstants.SHA256_UNAVAILABLE, ex);
        }
    }
}
