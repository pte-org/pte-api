...
/**
 * Two chains: {@code /internal/**} (service-to-service, API-key — exam-delivery
 ...
 * evaluated first, then the normal JWT resource-server chain. See authoring's
 * {@code SecurityConfig} for the identical base pattern; the bootstrap filter
 * is new here (Phase 9).
 */
@Configuration
