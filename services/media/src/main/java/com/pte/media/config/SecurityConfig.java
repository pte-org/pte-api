 ...
 * first, then the normal JWT resource-server chain — added for the
 * listening-exam-policy feature's presigned-GET internal endpoint (exam-delivery
 * needs a download URL at StartAttempt pin time). See scheduling's identical pattern.
 */
@Configuration
