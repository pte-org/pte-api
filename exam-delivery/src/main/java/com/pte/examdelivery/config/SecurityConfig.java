...
/**
 * exam-delivery only exposes student-facing endpoints (resource server, JWT via
 * JWKS) — it has no {@code /internal/**} surface of its own (it's a caller of
 * authoring/scheduling's internal endpoints, not a provider).
 */
@Configuration
